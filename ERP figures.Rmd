...
P7.plot <- ggplot(P7, aes(y = amplitude_µV, x = time_ms)) + geom_line(aes(color=condition))+
  scale_color_manual(values=c('#CC0000','#000099'))+ scale_y_continuous(breaks = c(seq(-6.75, 6.75, 2)), limits =c(-6.75, 6.75), expand = c(0,0),labels = c(rep("-",7)))+scale_x_continuous(breaks =c(seq(-100, 1000, 200)),limits = c(-100, 1000), expand = c(0,0))+labs(title="P7", x="Time(ms)", y="Amplitude(µV)")+theme_goeun()+ geom_vline(xintercept=0)+geom_hline(yintercept=0)
P7.plot 

# P8 channel 96 plot
P8.plot <- ggplot(P8, aes(y = amplitude_µV, x = time_ms)) + geom_line(aes(color=condition))+
  scale_color_manual(values=c('#CC0000','#000099'))+ scale_y_continuous(breaks = c(seq(-6.75, 6.75, 2)), limits =c(-6.75, 6.75), expand = c(0,0))+scale_x_continuous(breaks =c(seq(-100, 1000, 200)),limits = c(-100, 1000), expand = c(0,0))+labs(title="P7", x="Time(ms)", y="Amplitude(µV)")+theme_goeun()+ geom_vline(xintercept=0)+geom_hline(yintercept=0)
P8.plot
