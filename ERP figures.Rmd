...
PO8.plot <- ggplot(PO8, aes(y = amplitude_µV, x = time_ms)) + geom_line(aes(color=condition,linetype=condition))+
  scale_color_manual(values=c('#CC0000','#000099','#CC0000','#000099'))+scale_linetype_manual(values=c("solid","solid", "dotted", "dotted"))+scale_y_continuous(breaks = c(seq(-6.5, 6.5, 6.5)), limits =c(-6.75, 6.75), expand = c(0,0))+scale_x_continuous(breaks =c(seq(-100, 700, 800)),limits = c(-100, 700), expand = c(0,0))+labs(title="PO8", x="Time(ms)", y="Amplitude(µV)")+theme_goeun()+ geom_vline(xintercept=0)+geom_hline(yintercept=0)
...
Pz.plot <- ggplot(Pz, aes(y = amplitude_µV, x = time_ms)) + geom_line(aes(color=condition,linetype=condition))+
  scale_color_manual(values=c('#CC0000','#000099','#CC0000','#000099'))+scale_linetype_manual(values=c("solid","solid", "dotted", "dotted"))+scale_y_continuous(breaks = c(seq(-6.5, 6.5, 6.5)), limits =c(-6.75, 6.75), expand = c(0,0))+scale_x_continuous(breaks =c(seq(-100, 700, 800)),limits = c(-100, 700), expand = c(0,0))+labs(title="Pz", x="Time(ms)", y="Amplitude(µV)")+theme_goeun()+ geom_vline(xintercept=0)+geom_hline(yintercept=0)
...
Cz.plot <- ggplot(Cz, aes(y = amplitude_µV, x = time_ms)) + geom_line(aes(color=condition,linetype=condition))+
  scale_color_manual(values=c('#CC0000','#000099','#CC0000','#000099'))+scale_linetype_manual(values=c("solid","solid", "dotted", "dotted"))+scale_y_continuous(breaks = c(seq(-6.5, 6.5, 6.5)), limits =c(-6.75, 6.75), expand = c(0,0))+scale_x_continuous(breaks =c(seq(-100, 700, 800)),limits = c(-100, 700), expand = c(0,0))+labs(title="Cz", x="Time(ms)", y="Amplitude(µV)")+theme_goeun()+ geom_vline(xintercept=0)+geom_hline(yintercept=0) 
